...
//         float moveHorizontal = Input.GetAxis("Horizontal");
//         //Debug.Log(moveHorizontal);
//         Vector3 targetPosition = new Vector3(Mathf.Clamp(gameObject.transform.position.x + moveHorizontal, -2.5f, 2.5f),gameObject.transform.position.y,gameObject.transform.position.z);

//     // Move towards the target position
//     transform.position = Vector3.MoveTowards(transform.position, targetPosition, directionalSpeed * Time.deltaTime);
// #endif         
//         GetComponent<Rigidbody>().velocity = Vector3.forward * playerSpeed * Time.deltaTime;
